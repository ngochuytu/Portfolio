...
import { NavigationBar, NavigationList, NavigationListItem, NavigationLink } from "./FloatingNavigation.style";
...
function FloatingNavigation() {
    ...
    useEffect(() => {
        const handleScroll = () => {
            const aboutTopFromViewPort = document.getElementById("about").getBoundingClientRect().top;
            const projectsTopFromViewPort = document.getElementById("projects").getBoundingClientRect().top;
            const skillsTopFromViewPort = document.getElementById("skills").getBoundingClientRect().top;
            const contactTopFromViewPort = document.getElementById("contact").getBoundingClientRect().top;

            const sectionsTopFromViewPort = [aboutTopFromViewPort, projectsTopFromViewPort, skillsTopFromViewPort, contactTopFromViewPort];
