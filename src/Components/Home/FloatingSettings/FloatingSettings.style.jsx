...
const SettingsContainer = styled.ul`
  --background-color-settings-container: rgb(33, 37, 50, 0.8);
  ...
  transition-delay: ${(props) =>
    props.active
      ? "0"
      : "0.2s"}; /*--item-transition-delay-scale * highestDelay*/
`;
...
const SettingsItem = styled.li`
  ...
  border-radius: 50%;
  transform: ${(props) =>
    `translate(calc(var(--item-translate-scale) * ${props.posX}), calc(var(--item-translate-scale) * ${props.posY}))`};
  ...
  transition-delay: ${(props) =>
    `calc(var(--item-transition-delay-scale) * ${props.delay})`};
