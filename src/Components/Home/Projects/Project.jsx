...
function Project({
  ...
  projectTitle,
  projectDescription,
  projectDemoLinkTitle,
  projectDemoLink,
  projectGithubLinkTitle,
  projectGithubLink,
  projectDemoVideo,
  projectThumbImage,
  customRightContent,
  ...
  return (
    <ProjectContainer>
      ...
      <RightContent>
        {customRightContent ? (
          ...
          <>
            ...
            <ProjectThumbImage
              src={projectThumbImage}
              ref={projectImageRef}
              alt={`${projectTitle} Thumbnail Image`}
            />
          </>
        )}
      </RightContent>
      <SubContent>
        <ProjectLinks>
          <ProjectLink href={projectDemoLink} target="_blank" tabIndex={0}>
            {projectDemoLinkTitle}{" "}
            <Icon src={RightArrowIcon} alt="Right Arrow Icon" />
          </ProjectLink>
          <ProjectLink href={projectGithubLink} target="_blank" tabIndex={0}>
            {projectGithubLinkTitle}{" "}
            <Icon src={RightArrowIcon} alt="Right Arrow Icon" />
          </ProjectLink>
        </ProjectLinks>
