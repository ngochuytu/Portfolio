        ...
        projects: [
            {
                ...
                description: "Building Facebook Application using ReactJS and Firebase, this build recreated the basic functionality (sign up, log in, CRUD posts, real-time notifications, …) of the original Facebook.",
            ...
            },
            {
                header: "Project",
                title: "Shoe Store",
                description: "An online shoe store E-commerce using Asp.net WebForm. Functionalities include: Sign up, log in, adding product to cart, searching for products",
                demoLinkTitle: "Visit website",
            ...
            },
            {
                header: "Project",
                title: "Music Player",
                description: "A basic music player that allows you to go forward, backward, repeat, play randomly, pause a song, add songs to favorite list, set time to stop playing.",
                demoLinkTitle: "Visit website",
        ...
        projects: [
            {
                header: "Dự án",
                title: "Facebook Clone",
                description: "Website clone Facebook sử dụng ReactJS và Firebase với các chức năng cơ bản (đăng kí, đăng nhập, CRUD bài viết, thông báo thời gian thực).",
            ...
            },
            {
                ...
                description: "Website bán giày sử dụng Asp.net WebForms với các chức năng: Đăng kí, đăng nhập, giỏ hàng, tìm kiếm sản phẩm, lọc sản phẩm...",
                demoLinkTitle: "Xem trực tiếp",
                demoLink: "http://bangiay.somee.com/",
                githubLinkTitle: "Github",
                githubLink: "https://github.com/ngochuytu/bangiay",
            ...
            },
            {
                header: "Dự án",
                title: "Music Player",
                description: "Trình phát nhạc đơn giản cho phép bạn nghe nhạc, tìm kiếm, thêm vào danh sách yêu thích, hẹn giờ phát",
                demoLinkTitle: "Xem trực tiếp",
                demoLink: "https://ngochuytu.github.io/Music",
                githubLinkTitle: "Github",
                githubLink: "https://github.com/ngochuytu/Music",
